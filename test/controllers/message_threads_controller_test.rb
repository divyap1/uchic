...
class MessageThreadsControllerTest < ActionController::TestCase
  ...
  test "should create message_thread" do
    assert_difference('MessageThread.count') do
      post :create, message_thread: { buyer_id: @message_thread.buyer_id, commission_id: @message_thread.commission_id, seller_id: @message_thread.seller_id }
    end
  ...
  test "should update message_thread" do
    patch :update, id: @message_thread, message_thread: { buyer_id: @message_thread.buyer_id, commission_id: @message_thread.commission_id, seller_id: @message_thread.seller_id }
    assert_redirected_to message_thread_path(assigns(:message_thread))
  end
